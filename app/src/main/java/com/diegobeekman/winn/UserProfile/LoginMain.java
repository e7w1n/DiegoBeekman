            ...
            public void onClick(View v) {
                ...
                mAuth.signInWithEmailAndPassword(email, password) /* use the firebase authentication object to sumun this method signWithEmailAndPassword
                  add pass these 2 parameters */
                        ...
                        .addOnCompleteListener(com.diegobeekman.winn.UserProfile.LoginMain.this, new OnCompleteListener<AuthResult>() {
                            @Override
...
//                finish();
        ...
        forgetPassTextView.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent forgotPassIntent = new Intent(getApplicationContext(),
                        com.diegobeekman.winn.Login_Signup.ForgotPasswordActivity.class);
...
//        com.example.diegobeekman_basicactivity.UserProfile.LoginMain.class);
...
//    }
    ...
    Intent checkifalreadylogin = new Intent(getApplicationContext(), LoginGetUserName.class);
