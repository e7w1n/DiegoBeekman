        ...
        signUpButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (signUpEmailTextInput.getText().toString().contentEquals("")) {
                    ...
                    mAuth.createUserWithEmailAndPassword(signUpEmailTextInput.getText().toString(), signUpPasswordTextInput.getText().toString()).addOnCompleteListener(com.diegobeekman.winn.Login_Signup.SignUpActivity.this, new OnCompleteListener<AuthResult>() {
                        @Override
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()) {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
                                                                    com.diegobeekman.winn.Login_Signup.SignUpActivity.this);
                                                            ...
                                                            alertDialogBuilder
                                                                    ...
                                                                    .setPositiveButton("Sign In", new DialogInterface.OnClickListener() {
                                                                        public void onClick(DialogInterface dialog, int id) {
                                                                            ...
                                                                            Intent signInIntent = new Intent(com.diegobeekman.winn.Login_Signup.SignUpActivity.this, SignInActivity.class);
                                                                            com.diegobeekman.winn.Login_Signup.SignUpActivity.this.finish();
                                                                        }
                                                                    });
                                ...
                                Toast.makeText(com.diegobeekman.winn.Login_Signup.SignUpActivity.this, "Authentication failed.",
